<x-default-layout>
    ...
    <script>
        ...
        document.addEventListener('livewire:init', function () {
            log('🚀 Supply Purchase page initialized with PRODUCTION notification integration');

            // ✅ PRODUCTION INTEGRATION: Setup integration with production notification system
            window.SupplyPurchasePageNotifications = {
                init: function() {
                    log('🔧 Initializing Supply Purchase page notification integration');
                ...
                setupFallbackMode: function() {
                    log('🔄 Setting up fallback notification mode for Supply Purchase page');
                            ...
                            if (data.notifications && data.notifications.length > 0) {
                                data.notifications.forEach(notification => {
                                    if (this.isSupplyPurchaseNotification(notification)) {
                                        log('📨 [Page] Supply purchase notification detected:', notification.title);
                ...
                handleSupplyPurchaseNotification: function(notification) {
                    log('🎯 [Page] Handling supply purchase notification:', notification);
        ...
        document.addEventListener('keydown', function(e) {
            ...
            if (e.ctrlKey && e.shiftKey && e.key === 'P') {
                e.preventDefault();
                log('🎯 Testing supply purchase notification via keyboard shortcut');
                testNotificationFromPage();
            }
        });

        // Log when page is ready
        log('📦 Supply Purchase page scripts loaded successfully');

        // ✅ GLOBAL LIVEWIRE EVENT LISTENER FOR ALL SUPPLY PURCHASE NOTIFICATIONS
        document.addEventListener('DOMContentLoaded', function() {
            log('🚀 Supply Purchase Index - Setting up global notification listeners');
        ...
        function reloadDataTable() {
            ...
            try {
                ...
                log('❌ All DataTable reload methods failed');
        ...
        function testNotificationFromPage() {
            log('🧪 Testing notification from Supply Purchase page');
        ...
        document.addEventListener('keydown', function(e) {
            ...
            if (e.ctrlKey && e.shiftKey && e.key === 'P') {
                e.preventDefault();
                log('⌨️ Keyboard shortcut: Testing Supply Purchase notification');
                testNotificationFromPage();
            }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (window.SSENotificationSystem) {
                ...
                window.SSENotificationSystem.handleSupplyPurchaseNotification = function(notification) {
                    log('🔗 SSE-Livewire bridge: Supply purchase notification received');
