        ...
        element.addEventListener("click", function () {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.dispatch("deleteSupplyPurchaseBatch", [
                        this.getAttribute("data-kt-transaction-id"),
                    ]);
                }
            });
        });
...
document
    ...
    .forEach(function (element) {
        element.addEventListener("click", function (e) {
            ...
            // Get transaction ID
            const transactionId = event.currentTarget.getAttribute(
