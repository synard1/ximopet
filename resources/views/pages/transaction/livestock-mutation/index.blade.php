<x-default-layout>
    ...
    @section('breadcrumbs')
    @endsection
    @if(auth()->user()->can('read livestock mutation'))
    <div class="card">
        <!--begin::Card header-->
        <div class="card-header border-0 pt-6">
            ...
            @if(auth()->user()->can('create livestock mutation'))
            <!--begin::Card toolbar-->
    ...
    <div class="card">
        <div class="card-body">
            <div class="text-center">
                ...
                <p class="text-muted">You do not have permission to view livestock mutation.</p>
            </div>
        </div>
    </div>
    @endif
    @include('pages.masterdata.livestock._modal_mutation_details')
