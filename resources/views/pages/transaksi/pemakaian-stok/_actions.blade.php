...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
    ...
    <div class="menu-item px-3">
        <a href="{{ route('master-data.stokMutasis.show', $stokMutasi) }}" class="menu-link px-3">
            View
        </a>
    </div>
    <!--end::Menu item--> --}}
    ...
    <!--begin::Menu item-->
    <div class="menu-item px-3">
        <a href="#" class="menu-link px-3" data-kt-stokMutasi-id="{{ $stokMutasi->id }}" data-kt-action="delete_row">
        {{-- <a href="#" class="menu-link px-3" wire:click="delete({{ $stokMutasi->id }})"> --}}
            Delete
        </a>
    </div>
    <!--end::Menu item-->
