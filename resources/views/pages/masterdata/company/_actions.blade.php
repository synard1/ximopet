...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
    ...
    <div class="menu-item px-3">
        <a href="#" class="menu-link px-3" data-kt-company-id="{{ $company->id }}" data-kt-action="update_row">
            Edit
        </a>
    ...
    <!--begin::Menu item-->
    <div class="menu-item px-3">
        <a href="#" class="menu-link px-3" data-kt-company-id="{{ $company->id }}" data-kt-action="delete_row">
            Delete
        </a>
    </div>
    <!--end::Menu item-->
