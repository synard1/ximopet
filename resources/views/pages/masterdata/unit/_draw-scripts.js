        ...
        element.addEventListener("click", function () {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.dispatch("delete_unit", [
                        this.getAttribute("data-kt-unit-id"),
                    ]);
                }
            });
        });
...
document
    ...
    .forEach(function (element) {
        element.addEventListener("click", function (e) {
            ...
            // Get supplier ID
            const unitId = event.currentTarget.getAttribute("data-kt-unit-id");
            ...
            Swal.fire({
                html: `Membuka Data <b>` + unitName + `</b>`,
                icon: "info",
                buttonsStyling: false,
                ...
                Livewire.dispatch("showEditForm", [unitId]);
            });
        });
    });
