        ...
        element.addEventListener("click", function () {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.dispatch("deleteStrainStandard", [
                        this.getAttribute("data-kt-livestock-standard-id"),
                    ]);
                }
            });
        });
    ...
    .forEach(function (element) {
        element.addEventListener("click", function (e) {
            ...
            Swal.fire({
                ...
                Livewire.dispatch("editStrainStandard", [strainId]);
            });
        });
    });
...
Livewire.on("success", (message) => {
    ...
    LaravelDataTables["livestock-standard-table"].ajax.reload();
});
