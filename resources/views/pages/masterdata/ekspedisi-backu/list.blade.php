<x-default-layout>
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Cari Data" id="searchEkspedisi"/>
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
    ...
    <script>
        $(document).ready(function() {
            ...
            document.getElementById('searchEkspedisi').addEventListener('keyup', function () {
                window.LaravelDataTables['companies-table'].search(this.value).draw();
            });
