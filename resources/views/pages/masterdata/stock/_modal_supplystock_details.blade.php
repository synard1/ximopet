<!-- Modal -->
<div class="modal fade" id="kt_modal_supplystock_details" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="supplystockDetailsContainer" class="accordion" style="max-height: 70vh; overflow-y: auto;">
                    <!-- Data supplystock Grouped by Batch akan dimuat di sini via JS -->
                </div>
            </div>
...
@push('scripts')
    <script>
        ...
        $('#kt_modal_supplystock_details').on('show.bs.modal', function () {
            // $.ajax({
        ...
        function exportAllTablesToExcel() {
            const tables = document.querySelectorAll('#supplystockDetailsContainer table');
            let html = '';
            ...
            a.download = `supplystock_histories_all.xls`;
            a.click();
        }
