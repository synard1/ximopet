<x-default-layout>
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="h3 mb-2 text-gray-800">📊 Laporan Pembelian Pakan</h2>
                <p class="text-muted">Analisis detail pembelian pakan berdasarkan batch, supplier, dan periode</p>
            </div>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">🔍 Filter Laporan Pembelian Pakan</h6>
            </div>
            <div class="card-body">
                <form id="reportForm" method="GET" action="{{ route('purchase-reports.export-pakan') }}">
                    @csrf
                    <div class="row">
                        <!-- Date Range -->
                        ...
                        <!-- Feed Filter -->
                        <div class="col-md-3 mb-3">
                            <label for="feed_id" class="form-label">Jenis Pakan</label>
                            <select class="form-control" name="feed_id" id="feed_id">
