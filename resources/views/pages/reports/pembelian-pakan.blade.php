<x-default-layout>
    ...
    @section('title', 'Laporan Pembelian Pakan - ' . $summary['period'])
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm">
                    <div class="card-body text-center py-4"
                        ...
                        <h2 class="mb-2">📊 LAPORAN PEMBELIAN PAKAN</h2>
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                    Total Quantity</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    {{ number_format($summary['total_quantity'], 2) }} Kg
                                </div>
                            </div>
                            <div class="col-auto">
            ...
            <div class="col-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">📦 Detail Batch Pembelian Pakan</h6>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-bordered" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $batch->feedPurchases->count() }}</td>
                                        <td class="text-right">
