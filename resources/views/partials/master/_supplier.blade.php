...
<div class="modal fade" id="kt_modal_master_supplier" tabindex="-1" aria-hidden="true">
	<!--begin::Modal dialog-->
	<div class="modal-dialog modal-dialog-centered mw-650px">
		...
		<div class="modal-content rounded">
			...
			<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
				<!--begin:Form-->
				<form id="kt_modal_master_supplier_form" class="form" action="#">
					<!--begin::Heading-->
					<div class="mb-13 text-center">
						<!--begin::Title-->
						<h1 class="mb-3">Data Supplier</h1>
						<!--end::Title-->
						<!--begin::Description-->
					...
					<div class="text-center">
						<button type="reset" id="kt_modal_master_supplier_cancel" class="btn btn-light me-3">Cancel</button>
						<button type="submit" id="kt_modal_master_supplier_submit" class="btn btn-primary">
