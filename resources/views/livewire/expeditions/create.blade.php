                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge bg-{{ $row->status === 'active' ? 'success' : 'warning' }}">{{
                                            ucfirst($row->status) }}</span>
                                    </td>
                                    <td>
                                        <div class="d-flex gap-2">
                                            <button wire:click="$dispatch('showEditModal', [@js($row->id)])"
                                            ...
                                            {{-- <button wire:click="$dispatch('delete', [@js($row->id)])"
                                                class="btn btn-sm btn-outline-danger shadow-sm">
                                                <i class="bi bi-trash"></i> Hapus
                                            </button> --}}
                                        </div>
                                ...
                                @empty
                                <tr>
                                    <td colspan="6" class="text-center py-4">Tidak ada data ekspedisi.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="expeditionModalLabel"><i class="bi bi-truck me-2"></i> {{ $modalId ?
                        'Edit Ekspedisi' : 'Tambah Ekspedisi' }}</h5>
                ...
                <form wire:submit.prevent="{{ $modalId ? 'update' : 'create' }}">
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input wire:model.debounce.800ms="code" type="text"
                        ...
                        <div class="mb-3">
                            ...
                            <input wire:model.debounce.800ms="contact_person" type="text"
                        ...
                        <div class="mb-3">
                            ...
                            <input wire:model.debounce.800ms="phone_number" type="text"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea wire:model.debounce.800ms="address"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea wire:model.debounce.800ms="description"
                        ...
                        <div class="mb-3">
                            ...
                            <select wire:model.debounce.800ms="status"
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                            wire:click="closeModal"><i class="bi bi-x-circle me-1"></i> Batal</button>
