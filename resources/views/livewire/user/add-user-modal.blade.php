                            ...
                            <div class="d-flex fv-row">
                                ...
                                <div class="form-check form-check-custom form-check-solid">
                                    ...
                                    <input class="form-check-input me-3"
                                        ...
                                        type="radio" value="{{ $role->name }}" checked="checked" />
                                    <!--end::Input-->
                                    <!--begin::Label-->
...
<script>
    ...
    //     Livewire.on('error-modal', function () {
    //         console.log('error-modal');
    //         showUserBlockersModal(data, false);
    //     });
    //     Livewire.on('confirm', function () {
    //         console.log('confirm');
    //         showUserBlockersModal(data, false);
    //     });
    // });
    document.addEventListener('DOMContentLoaded', function () {
        window.livewire.on('error-modal', function (data) {
            console.log('Blockers:', data.blockers);
            showUserBlockersModal(data, false);
        });
        window.livewire.on('confirm', function (data) {
            console.log('Blockers:', data.blockers);
            if (data.blockers) {
                console.log('confirm', data);
                showUserBlockersModal(data, true, data);
            }
        });
    });
