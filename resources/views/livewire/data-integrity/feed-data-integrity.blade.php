<div>
    <div class="p-6 bg-white rounded-lg shadow-lg">
        <h2 class="text-2xl font-bold mb-4">Feed Data Integrity Check</h2>
        ...
        <div class="mb-4 p-4 bg-yellow-100 border border-yellow-400 text-yellow-700 rounded">
            ...
            <p>Found {{ $invalidStocksCount }} invalid feed stock records. Click the red button above to delete these
            ...
            <div class="space-y-4">
                ...
                <div class="p-4 rounded-lg border
                    ...
                    <div class="font-semibold flex items-center gap-2">
                        ...
                        @php
                        $canRestore =
                        app()->make(\App\Livewire\FeedDataIntegrity::class)->canRestore($log['data']['source_type'],
                        $log['data']['source_id']);
                        @endphp
                        @if($canRestore)
                        <button
