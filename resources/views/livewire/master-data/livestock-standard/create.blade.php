    ...
    <div class="card">
        <div class="card-header">
            <div class="card-title">
                <h3 class="card-title">{{ $isEditing ? 'Edit' : 'Create' }} Form Standar {{ $strain_name ?? ''
                    }}</h3>
            </div>
            <div class="card-toolbar">
                <div class="d-flex justify-content-end">
                    <button type="button" class="btn btn-secondary" onclick="Livewire.dispatch('closeForm')">
                        Kembali
                    </button>
                </div>
            </div>
            ...
            <form wire:submit.prevent="saveOrUpdateStrainStandard">
                <div class="mb-5">
                    ...
                    <select wire:model="strain_id" class="form-select form-select-solid" @if($isEditing) disabled
                        ...
                        @foreach($livestockStrain as $strain)
