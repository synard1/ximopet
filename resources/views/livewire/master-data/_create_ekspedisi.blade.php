<div class="modal d-block" tabindex="-1" role="dialog" id="kt_modal_master_ekspedisi" tabindex="-1" aria-hidden="true" wire:ignore.self>
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ $ekspedisi_id ? 'Ubah Data Ekspedisi' : 'Buat Data Ekspedisi' }}</h5>
                <!--begin::Close-->
            ...
            <div class="modal-body">
                <form>
                    <div class="fv-row mb-7">
                        ...
                        <input type="text" class="form-control" wire:model="kode" id="kode" {{ $ekspedisi_id ? 'disabled' : '' }}>
