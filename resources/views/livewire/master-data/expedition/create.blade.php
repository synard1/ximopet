<div>
    ...
    <form wire:submit.prevent="save">
        {{-- === Informasi Utama Ekspedisi === --}}
        <div class="row g-3">
            <x-input.group col="6" label="Kode">
                <input type="text" wire:model="code" class="form-control" placeholder="Masukkan Kode Ekspedisi">
                <x-input.error for="code" />
            </x-input.group>

            <x-input.group col="6" label="Nama Ekspedisi">
                <input type="text" wire:model="name" class="form-control" placeholder="Masukkan Nama Ekspedisi">
        ...
        <div class="d-flex justify-content-end my-4">
            <button type="button" class="btn btn-secondary me-2" wire:click="closeModalExpedition">Batal</button>
