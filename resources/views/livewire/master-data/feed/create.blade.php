    ...
    <form wire:submit.prevent="save">
        ...
        <div class="row g-3">
            ...
            <x-input.group col="6" label="Jenis">
                <select wire:model="type" class="form-select" readonly>
            ...
            {{-- <x-input.group col="6" label="Satuan Default">
                <x-select wire:model.live="unit_id" placeholder="Pilih Satuan"
                    :options="['' => '-- Pilih --'] + $units->pluck('name', 'id')->toArray()" searchable label=""
                    class="form-select" />
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{-- <input type="checkbox"
                                        wire:click="toggleDefault('is_default_purchase', {{ $index }})" {{
                                        $conversion['is_default_purchase'] ? 'checked' : '' }}> --}}
                                    <input type="checkbox"
                                ...
                                <td>
                                    {{-- <input type="checkbox"
                                        wire:click="toggleDefault('is_default_mutation', {{ $index }})" {{
                                        $conversion['is_default_mutation'] ? 'checked' : '' }}> --}}
                                    <input type="checkbox"
                                ...
                                <td>
                                    {{-- <input type="checkbox"
                                        wire:click="toggleDefault('is_default_sale', {{ $index }})" {{
                                        $conversion['is_default_sale'] ? 'checked' : '' }}> --}}
                                ...
                                <td>
                                    {{-- <input type="checkbox" wire:click="toggleDefault('is_smallest', {{ $index }})"
                                        {{ $conversion['is_smallest'] ? 'checked' : '' }}> --}}
