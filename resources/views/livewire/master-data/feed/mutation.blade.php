    ...
    <form wire:submit.prevent="save">
        <div class="row g-3">
            <x-input.group col="md-6" label="Asal" for="source_livestock_id">
                <select wire:model="source_livestock_id" class="form-select" required @disabled($edit_mode)>
        ...
        <div class="row align-items-end mb-3">
            ...
            <div class="col-md-3">
                ...
                <select class="form-select @error('items.'.$index.'.item_id') is-invalid @enderror" wire:model.live="items.{{ $index }}.item_id">
            ...
            <div class="col-md-2">
                ...
                <select class="form-select @error('items.'.$index.'.unit_id') is-invalid @enderror" wire:model="items.{{ $index }}.unit_id">
