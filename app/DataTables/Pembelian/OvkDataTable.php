...
class OvkDataTable extends DataTable
{
    /**
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('total_qty')->title('Total ( Kg / Liter )')->searchable(false),
