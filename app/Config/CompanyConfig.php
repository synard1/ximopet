...
class CompanyConfig
{
    ...
    public static function getDefaultTemplateConfig(): array
    {
        return [
            ...
            'sales' => self::getDefaultSalesConfig(), // 🆕 DEDICATED SALES CONFIG
        ...
        return [
            'livestock_purchase' => [
                ...
                'batch_settings' => [
                    ...
                    'allow_multiple_batches' => [
                        ...
                        'depletion_method_manual' => [ // Manual depletion - user can manually select batch
                            'enabled' => false,
                            'track_age' => false, // Don't track age for manual
                            'min_age_days' => 0,
                            'max_age_days' => null,
                        ],
                    ],
                ...
                'approval_settings' => [
                    ...
                    'auto_approve_threshold' => 1000000, // 1 juta
                ],
                'document_settings' => [
                    'require_do_number' => false,
                    'require_invoice' => true,
     ...
     * 🆕 DEDICATED SALES CONFIG - Comprehensive sales management settings
     */
    public static function getDefaultSalesConfig(): array
    {
        return [
            'livestock_sales' => [
                'enabled' => true,
                'recording_method' => [
                    'type' => 'two_stage', // 'two_stage', 'direct', 'batch_only'
                ...
                'quantity_calculation' => [
                    ...
                    'virtual_settings' => [
                        ...
                        'calculation_method' => 'projection', // 'projection', 'estimate', 'forecast'
                        'projection_settings' => [
                            'enabled' => true,
                ...
                'batch_allocation' => [
                    'method' => 'fifo', // 'fifo', 'lifo', 'manual', 'weight_based'
                    'fifo_settings' => [
                        'enabled' => true,
                ...
                'validation_rules' => [
                    'require_quantity' => true,
                    'require_weight' => false, // Optional for recording
                    'require_price' => false, // Optional for recording
                    'require_customer' => false, // Optional for recording
                    'min_quantity' => 1,
                    'max_quantity_per_sale' => 10000,
                    'weight_validation' => [
                        'enabled' => true,
                        'min_weight_per_unit' => 0.1, // kg
                        'max_weight_per_unit' => 10.0, // kg
                ...
                'pricing' => [
                    'pricing_method' => 'manual', // 'manual', 'market_price', 'cost_plus', 'fixed'
            ...
            'sales_recording' => [
                'enabled' => true,
                'recording_method' => [
                    'type' => 'integrated', // 'integrated', 'separate', 'manual_only'
    ...
    /**
     * Get sales config from active config
     */
    ...
    /**
     * Get sales recording config from active config
     */
    ...
    /**
     * Get sales history config from active config
     */
    ...
    /**
     * Get sales batch allocation method
     */
    ...
    /**
     * Check if two-stage sales is enabled
     */
    ...
    /**
     * Get sales auto-approve threshold
     */
