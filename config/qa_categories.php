    ...
    */
    ...
    'categories' => [
        ...
        'Master Data' => [
            ...
            'Coop' => [
                'Coop CRUD Operations' => [
                    'test_case' => 'Verify Coop CRUD operations',
                    'test_steps' => implode("\n", [
                        '1. Navigate to /master/coops.',
                        '2. Check if the page loads properly and displays all coop data in table format.',
                        '3. Verify pagination works correctly.',
                        '4. Test search functionality to find a specific coop.',
                        '5. Test sorting on all columns.',
                        '6. Click "Add New Coop" button, fill in all required fields, and submit the form to create a new coop.',
                        '7. Verify the new coop appears in the list.',
                        '8. Click edit button on any coop, modify coop details, and save changes.',
                        '9. Verify changes are reflected in the list.',
                        '10. Click delete button on any coop, confirm deletion, and verify the coop is removed from the list.',
                    ]),
                    'expected_result' => 'Coop CRUD operations should work correctly, including displaying, creating, editing, and deleting coops.',
                    'test_type' => 'Functional',
                    'priority' => 'High',
                    'status' => 'Not Tested',
                    'notes' => '',
                ...
                'Coop Deletion Validation' => [
                    'test_case' => 'Verify that a coop cannot be deleted if it has associated batch of chickens',
                    'test_steps' => implode("\n", [
                        '1. Navigate to /master/coops.',
                        '2. Create a new batch of chickens and associate it with an existing coop.',
                        '3. Attempt to delete the coop with associated batch of chickens.',
                        '4. Verify that a warning message is displayed indicating that the coop cannot be deleted due to existing batch of chickens.',
                        '5. Confirm that the coop still appears in the list after the deletion attempt.',
                    ]),
                    'expected_result' => 'The system should prevent the deletion of the coop and display an appropriate warning message.',
                    'test_type' => 'Data Validation',
                    'priority' => 'High',
                    'status' => 'Not Tested',
                    'notes' => '',
