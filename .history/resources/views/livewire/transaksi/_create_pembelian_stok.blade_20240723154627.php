                    ...
                    <div class="d-flex flex-column align-items-start flex-xxl-row">
                        ...
                        <div class="d-flex align-items-center flex-equal fw-row me-4 order-2" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-original-title="Specify invoice date" data-kt-initialized="1">
                            ...
                            <div class="position-relative d-flex align-items-center w-150px">
                                <!--begin::Datepicker-->
                                <input class="form-control form-control-transparent fw-bold pe-5 flatpickr-input" placeholder="Pilih Tanggal" wire:model="tanggal" name="invoice_date" type="text" readonly="readonly">
                                <!--end::Datepicker-->
                        ...
                        <div class="d-flex flex-center flex-equal fw-row text-nowrap order-1 order-xxl-2 me-4" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-original-title="Enter invoice number" data-kt-initialized="1">
                            ...
                            <input type="text" class="form-control form-control-flush fw-bold text-muted fs-3 w-125px" wire:model="faktur" value="000000" placehoder="...">
                            @error('faktur')
                            <span class="text-danger">{{ $message }}</span> @enderror
                            @error('faktur')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="d-flex align-items-center justify-content-end flex-equal order-3 fw-row" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-original-title="Specify invoice due date" data-kt-initialized="1">
                            ...
                            <div class="position-relative d-flex align-items-center w-150px">
                                <!--begin::Select2-->
                                <select id="supplier" data-control="select2" name="supplier" wire:model="supplier" class="form-control form-control-flush fw-bold text-muted fs-3 w-125px">
                                    <option value="">Pilih</option>
                                    @foreach ($suppliers as $xSupplier)
                                        <option value="{{ $xSupplier }}" @if($xSupplier == $supplier) selected @endif>{{ $xSupplier->nama }}</option>
                                    @endforeach
                                </select>
                                <!--end::Select2-->
