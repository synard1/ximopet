                                            ...
                                            <td>
                                                <select wire:model="items.{{ $index }}.name" class="form-select select2">
                                                    ...
                                                    @foreach($allItems as $availableItem)
                                                        ...
                                                        <option value="{{ $availableItem->id }}" @if($availableItem->id == $items[$index]) selected @endif>{{ $availableItem->nama }}</option>
                                                    @endforeach
                                                </select>
                                                <input type="hidden" wire:model="items.{{ $index }}.item_id">
                                            </td>
                                            <input type="text" class="form-control form-control-solid" min="1" placeholder="1" data-kt-element="quantity" value="{{ $items }}">
                                            <textarea aria-valuemax=""></textarea>
                                            <td class="ps-0">
