                                ...
                                <tbody>
                                    @foreach($items as $index => $item)
                                        <tr class="border-bottom border-bottom-dashed" data-kt-element="item">
                                            <td>
                                                <select wire:model="items.{{ $index }}.name" class="form-select select2">
                                                    ...
                                                    @foreach($allItems as $availableItem)
                                                        <option value="{{ $availableItem->nama }}">{{ $availableItem->nama }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <td>
                                                <input type="text" class="form-control form-control-solid text-end" wire:model="items.{{ $index }}.price" placeholder="0.00" data-kt-element="price" >
                                            </td>
                                            <td class="pt-8 text-end text-nowrap">
                                                $<span data-kt-element="total">{{ number_format($item['qty'] * $item['price'], 2) }}</span>
                                            </td>
                                ...
                                <tfoot>
                                    <tr class="border-top border-top-dashed align-top fs-6 fw-bold text-gray-700">
                                        <th class="text-primary">
                                            ...
                                            data-kt-element="add-item" wire:click="addItem"
                                        </th>  
