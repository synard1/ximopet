                    ...
                    <form id="kt_modal_master_doc_form" class="form" enctype="multipart/form-data">
                            ...
                            <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_master_doc_scroll"
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" wire:model="tanggal_pembelian" id="tanggal_pembelian"
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Select2-->
                                    <select id="supplierSelect" name="supplierSelect" wire:model="selectedFarm" class="js-select2 form-control">
