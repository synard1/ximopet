                                ...
                                <tbody>
                                    <tr class="border-bottom border-bottom-dashed" data-kt-element="item">
                                        <td class="pe-7">                                            
                                            ...
                                            <select wire:model="items.name" class="form-select select2">
                                                <option value="">Select Item</option>
                                                @foreach($allItems as $availableItem)
                                                    <option value="{{ $availableItem->name }}">{{ $availableItem->nama }}</option>
                                                @endforeach
                                            </select>
                                        </td>
        
                                        <td class="ps-0">                                            
                                            <input type="text" class="form-control form-control-solid" min="1" wire:model="items.quantity"  name="quantity[]" data-kt-element="quantity">
                                        </td>
