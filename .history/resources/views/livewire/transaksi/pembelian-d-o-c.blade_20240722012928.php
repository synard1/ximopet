                ...
                <div class="modal-body">
                    ...
                    <form id="kt_modal_master_doc_form" class="form" enctype="multipart/form-data">
                            ...
                            <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_master_doc_scroll"
                                ...
                                <div class="fv-row mb-7">
                                    <!--begin::Label-->
                                    <label class="required fw-semibold fs-6 mb-2">Nama DOC</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" wire:model="nama" name="nama" id="nama" value="{{ $nama }}"
                                        class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Nama DOC"/>
                                    <!--end::Input-->
                                    @error('nama')
                                    <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                ...
                                <div class="fv-row mb-7">
                                    <!--begin::Label-->
                                    <label class="required fw-semibold fs-6 mb-2">Kapasitas DOC</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" wire:model="kapasitas" name="kapasitas" id="kapasitas" value="{{ $kapasitas }}"
                                        class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Kapasitas DOC"/>
                                    <!--end::Input-->
                                    @error('kapasitas')
                                    <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
