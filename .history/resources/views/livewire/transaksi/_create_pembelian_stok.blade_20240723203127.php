<div class="card" id="stokFormCard" tabindex="-1" style="display: none;" wire:ignore.self>
            <div class="card-body">
                <form id="kt_pembelian_stok_form">
                    ...
                    <div class="d-flex flex-column align-items-start flex-xxl-row">
                        ...
                        <div class="d-flex flex-center flex-equal fw-row text-nowrap order-1 order-xxl-2 me-4" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-original-title="Enter invoice number" data-kt-initialized="1">
                            ...
                            <input type="text" class="form-control form-control-flush fw-bold text-muted fs-3 w-125px" wire:model="faktur" name="faktur" value="2021001" placehoder="...">
                            @error('faktur')
                            <span class="text-danger">{{ $message }}</span> @enderror
                            @error('faktur')
                                <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    {{-- @foreach($items as $index => $item)
                        <div class="item-row">
                            ...
                            <textarea wire:model="items.{{ $index }}.description" class="form-control" disabled></textarea>
                            <input type="number" wire:model="items.{{ $index }}.qty" min="1" class="form-control">
                            <input type="text" wire:model="items.{{ $index }}.price" class="form-control" disabled>
                            <button wire:click="removeItem({{ $index }})" class="btn btn-danger">-</button>
                        </div>
                    @endforeach --}}
                            ...
                            <table class="table g-5 gs-0 mb-0 fw-bold text-gray-700" data-kt-element="items">
                                ...
                                <tbody>
                                    <tr class="border-bottom border-bottom-dashed" data-kt-element="item">
                                        <td class="pe-7">                                            
                                            <input type="text" class="form-control form-control-solid mb-2" wire:model="name" name="name[]" placeholder="Item name">
                                        </td>
        
                                        <td class="ps-0">                                            
                                            <input type="text" class="form-control form-control-solid" min="1" wire:model="quantity"  name="quantity[]" placeholder="1" value="1" data-kt-element="quantity">
                                        </td>
                ...
                <button wire:click="addItem" type="button" class="btn btn-primary">Add Item</button> 
