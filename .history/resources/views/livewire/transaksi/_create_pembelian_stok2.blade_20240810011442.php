<div id="stokFormCard2" class="app-content  flex-column-fluid " tabindex="-1" style="display: none;" wire:ignore.self>
                                ...
                                <div class="d-flex align-items-center flex-equal fw-row me-4 order-2"
                                    ...
                                    <div class="position-relative d-flex align-items-center w-150px">
                                        ...
                                        <input
                                            ...
                                            placeholder="Select date" name="invoice_date" type="text"
                                            readonly="readonly">
                                        <!--end::Datepicker-->
                    ...
                    <div class="card-body p-10">
                        ...
                        <div class="mb-10">
                            ...
                            <select name="currnecy" aria-label="Select a Timezone" data-control="select2"
                                ...
                                data-select2-id="select2-data-9-xr36" tabindex="-1" aria-hidden="true"
                                data-kt-initialized="1">
                                <option value="" data-select2-id="select2-data-11-3gme"></option>

                                <option data-kt-flag="flags/united-states.svg" value="USD"
                                    data-select2-id="select2-data-154-iunb">USD&nbsp;-&nbsp;USA dollar</option>
                                <option data-kt-flag="flags/united-kingdom.svg" value="GBP"
                                    data-select2-id="select2-data-155-d7sd">GBP&nbsp;-&nbsp;British pound</option>
                                <option data-kt-flag="flags/australia.svg" value="AUD"
                                    data-select2-id="select2-data-156-1ksv">AUD&nbsp;-&nbsp;Australian dollar</option>
                                <option data-kt-flag="flags/japan.svg" value="JPY"
                                    data-select2-id="select2-data-157-w2af">JPY&nbsp;-&nbsp;Japanese yen</option>
                                <option data-kt-flag="flags/sweden.svg" value="SEK"
                                    data-select2-id="select2-data-158-16qu">SEK&nbsp;-&nbsp;Swedish krona</option>
                                <option data-kt-flag="flags/canada.svg" value="CAD"
                                    data-select2-id="select2-data-159-smz5">CAD&nbsp;-&nbsp;Canadian dollar</option>
                                <option data-kt-flag="flags/switzerland.svg" value="CHF"
                                    data-select2-id="select2-data-160-h73q">CHF&nbsp;-&nbsp;Swiss franc</option>
                            </select><span
                                class="select2 select2-container select2-container--bootstrap5 select2-container--below"
                                dir="ltr" data-select2-id="select2-data-10-oqm4" style="width: 100%;"><span
                                    class="selection"><span
                                        class="select2-selection select2-selection--single form-select form-select-solid"
                                        role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
                                        aria-disabled="false" aria-labelledby="select2-currnecy-ah-container"
                                        aria-controls="select2-currnecy-ah-container"><span
                                            class="select2-selection__rendered" id="select2-currnecy-ah-container"
                                            role="textbox" aria-readonly="true"
                                            title="GBP&nbsp;-&nbsp;British pound">GBP&nbsp;-&nbsp;British
                                            pound</span><span class="select2-selection__arrow" role="presentation"><b
