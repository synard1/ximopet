		...
		<div class="menu-sub menu-sub-accordion menu-state-gray-900 menu-fit open">
			...
			<div class="menu-item">
				...
				<span class="menu-link">
					...
					<span class="menu-badge">
						<button class="btn btn-sm btn-icon btn-action" data-bs-toggle="modal" data-bs-target="#kt_modal_new_stok">
							<i class="ki-outline ki-plus fs-4"></i>
						</button>
					</span>
				</span>
		...
		<div class="menu-sub menu-sub-accordion menu-state-gray-900 menu-fit open">
			...
			<div class="menu-item menu-accordion menu-fit">
				...
				<span class="menu-link">
					...
					<span class="menu-badge">
						<button class="btn btn-sm btn-icon btn-action" data-bs-toggle="modal" data-bs-target="#kt_modal_new_doc">
							<i class="ki-outline ki-plus fs-4"></i>
						</button>
					</span>
				</span>
				...
				<span class="menu-link">
					...
					<span class="menu-badge">
						<button class="btn btn-sm btn-icon btn-action" data-bs-toggle="modal" data-bs-target="#kt_modal_new_target">
							<i class="ki-outline ki-plus fs-4"><a href="/transaksi/stoks"></a></i>
						</button>
					</span>
				</span>
				<!--end:Menu link-->
