        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @endif
                    ...
                    <!--begin::Input group-->
                    <div class="fv-row mb-7">
                        <label for="password" class="required fw-semibold fs-6 mb-2">Password Confirmation</label>
                        <input type="passwordConfirmation" class="form-control" wire:model="passwordConfirmation" id="passwordConfirmation">
