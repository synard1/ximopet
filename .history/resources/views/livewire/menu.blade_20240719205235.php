...
@push('styles')
	{{-- <style>
		/* In your app.css or a separate Livewire stylesheet */
.modal-dialog { /* Or use your modal's specific class/ID */
...
@push('scripts')
	<script>
		...
		element.addEventListener('click', function () {
            ...
            $('#kt_modal_master_kandang').modal('show'); // Assuming your modal has the ID 'kt_modal_master_kandang'
        });
