<div class="modal d-block" tabindex="-1" role="dialog" id="kt_modal_master_farm" tabindex="-1" aria-hidden="true" wire:ignore.self>
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ $farm_id ? 'Ubah Data Customer' : 'Buat Data Customer' }}</h5>
                <!--begin::Close-->
            ...
            <div class="modal-body">
                <form>
                    <div class="fv-row mb-7">
                        ...
                        <input type="text" class="form-control" wire:model="kode" id="kode" {{ $farm_id ? 'disabled' : '' }}>
