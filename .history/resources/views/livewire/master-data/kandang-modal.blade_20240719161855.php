                ...
                <form id="kt_modal_master_kandang_form" class="form" enctype="multipart/form-data">
                        ...
                        <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_master_kandang_scroll"
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Select2-->
                                <select id="category" wire:model="category" name="category" class="js-select2 form-control">
                                    <option value="">=== Select Category ===</option>
                                    @foreach ($changeCategory as $categories)
                                    <option value="{{ $categories->id }}" @if($value == $category) selected @endif>{{ $categories->title }}</option>
                                    {{-- <option value="{{ $category->id }}"><b>{{ $category->title }}</b> -- {{
