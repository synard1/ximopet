<div class="modal" tabindex="-1" role="dialog" id="kt_modal_new_customer" tabindex="-1" aria-hidden="true" wire:ignore.self>
<div class="modal d-block" tabindex="-1" role="dialog" id="kt_modal_new_customer" tabindex="-1" aria-hidden="true" wire:ignore.self>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!--begin::Form-->
                <form id="kt_modal_master_customer_form" class="form" enctype="multipart/form-data">
                        <!--begin::Scroll-->
                        <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_master_customer_scroll"
                            data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto"
                            data-kt-scroll-dependencies="#kt_modal_master_customer_header"
                            data-kt-scroll-wrappers="#kt_modal_master_customer_scroll" data-kt-scroll-offset="300px">
                            <!--begin::Input group-->
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" wire:model="kode_customer" id="kode_customer"
