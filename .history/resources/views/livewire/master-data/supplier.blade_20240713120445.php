<div class="modal fade collapse show" id="kt_modal_master_supplier" tabindex="-1" aria-hidden="true" wire:ignore.self>
    <!--begin::Modal dialog-->
                ...
                <form id="kt_modal_master_supplier_form" class="form"  action="#" wire:submit="submit" enctype="multipart/form-data">
                    ...
                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_master_supplier_scroll"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" wire:model="kode_supplier" name="kode_supplier"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" id="telp" name="telp" wire:model="telp" class="form-control mb-2" placeholder="Telp" value="{{ $telp }}"/>
                            <!--begin::Input-->
                            <input type="text" id="alamat" name="alamat" class="form-control mb-2"
                            placeholder="Title" wire:model="alamat" value="{{ $alamat }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" id="email" wire:model="state.email" class="mt-1 block w-full">
