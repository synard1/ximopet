...
<div class="modal fade" id="kt_modal_master_supplier" tabindex="-1" aria-hidden="true" wire:ignore.self role="dialog">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body px-5 my-7">
                ...
                {{-- <form id="kt_modal_master_supplier_form" class="form"  action="#" wire:submit="{{ $edit_mode === true ? 'update' : 'submit' }}" enctype="multipart/form-data"> --}}
                    ...
                    <div class="text-center pt-15">
                        <button type="reset" class="btn btn-light me-3" data-bs-dismiss="modal" aria-label="Close"
                            ...
                            <button type="submit" wire:click="update({{ $supplier_id }})">Update</button>
