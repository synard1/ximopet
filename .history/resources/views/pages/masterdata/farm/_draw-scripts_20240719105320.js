...
document.querySelectorAll('[data-kt-action="update_row"]').forEach(function (element) {
    element.addEventListener('click', function (e) {
        ...
        Swal.fire({
            ...
            // showLoadingSpinner();
            // Livewire.on('update_farm', function (event) {
            //     // $('#kt_modal_master_farm').modal('show');
            //     // Assuming event.detail.farmId contains the actual ID:
            //     this.set('farm_id', event.detail.farmId); 
            // });
