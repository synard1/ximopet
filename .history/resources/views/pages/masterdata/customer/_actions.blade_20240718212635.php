...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
    ...
    <div class="menu-item px-3">
        ...
        {{-- <a href="#" class="menu-link px-3" data-kt-customer-id="{{ $customer->id }}" data-bs-toggle="modal" data-bs-target="#kt_modal_master_customer" data-kt-action="update_row"> --}}
        <a href="#" class="menu-link px-3" data-kt-customer-id="{{ $customer->id }}" data-kt-action="update_row">
            Edit
        </a>
