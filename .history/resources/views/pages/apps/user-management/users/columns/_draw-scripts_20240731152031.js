...
document.querySelectorAll('[data-kt-action="update_row"]').forEach(function (element) {
    element.addEventListener('click', function (e) {
        ...
        // Get supplier ID
        const userId = event.currentTarget.getAttribute('data-kt-supplier-id');
        ...
        Swal.fire({
            ...
            Livewire.on('update_supplier', function (event) {
                ...
                // Assuming event.detail.userId contains the actual ID:
                this.set('supplier_id', event.detail.userId); 
            });
