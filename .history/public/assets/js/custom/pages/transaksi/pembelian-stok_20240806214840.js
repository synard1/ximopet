        ...
        t = function () {
            ...
            t.map(function (e) {
                var t = e.querySelector('[data-kt-element="quantity"]'),
                    l = e.querySelector('[data-kt-element="harga"]'),
                    r = n.from(l.value);
                r = !r || r < 0 ? 0 : r;
    ...
    return {
        init: function (n) {
            (e = document.querySelector("#kt_pembelian_stok_form"))
                ...
                KTUtil.on(
                    e,
                    '[data-kt-element="items"] [data-kt-element="quantity"], [data-kt-element="items"] [data-kt-element="harga"]',
                    "change",
                    function (e) {
                        e.preventDefault(), t();
                    }
                ),
                $(e.querySelector('[name="tanggal"]')).flatpickr({
                    enableTime: !1,
                    dateFormat: "d-m-Y",
                }),
                t();
