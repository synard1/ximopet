...
{
    public $kandangs, $farms, $selectedFarm, $kode, $nama, $status = 'Aktif';
    ...
    {
        $this->selectedFarm = Farm::distinct('nama')
                                        ->pluck('nama')
                                        ->filter()
                                        ->toArray();
    }
    ...
    public function render()
    {
        ...
        return view('livewire.master-data.kandang-list', ['kandangs' => $this->kandangs, 'farms' => $this->farms]);
    }
