...
{
    public $stoks, $stok_id, $jenis, $kode_stok, $nama, $konversi, $satuan_besar, $satuan_kecil, $status = 'Aktif';
    public $isOpen = 0;
    ...
    {
        return view('livewire.master-data.stok-modal');
