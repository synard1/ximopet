...
{
    public $stoks, $farms, $selectedFarm, $stok_id, $kode_stok, $nama, $kapasitas, $status = 'Aktif';
    public $isOpen = 0;
    ...
    public function storeKandang()
    {
        try {
            ...
            $stok = Kandang::where('id', $this->stok_id)->first() ?? Kandang::create($data);
        
            DB::commit();
    
            // Emit success event if no errors occurred
            $this->dispatch('success', 'Kandang '. $stok->nama .' berhasil ditambahkan');
