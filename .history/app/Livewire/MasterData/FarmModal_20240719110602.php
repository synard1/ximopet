...
class FarmModal extends Component
{
    ...
    protected $rules = [
        'kode_farm' => 'required|unique:master_rekanan,kode',
    ...
    public function storeFarm()
    {
        try {
            ...
            $rekanan = Rekanan::where('id', $this->farm_id)->first() ?? Rekanan::create($data);
        
            DB::commit();
    
            // Emit success event if no errors occurred
            $this->dispatch('success', 'Farm '. $rekanan->nama .' berhasil ditambahkan');
