...
class AppApi
{
    ...
    {
        $options = TransaksiDetail::where('transaksi_id', $id)->get(['jenis','jenis_barang','nama','jumlah','terpakai', 'sisa', 'harga','sub_total']);

        $options['sisa']=$options['jumlah'] - $options['terpakai'];
